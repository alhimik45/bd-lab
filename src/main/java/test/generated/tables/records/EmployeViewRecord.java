...
public class EmployeViewRecord extends TableRecordImpl<EmployeViewRecord> implements Record6<String, String, String, Long, Long, String> {

    private static final long serialVersionUID = 1789036106;
     ...
     */
    @Override
    public EmployeViewRecord values(String value1, String value2, String value3, Long value4, Long value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EmployeViewRecord(String fio, String personalid, String name, Long personPk, Long employePk, String login) {
        super(EmployeView.EMPLOYE_VIEW);
