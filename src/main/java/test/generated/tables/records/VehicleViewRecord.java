...
public class VehicleViewRecord extends TableRecordImpl<VehicleViewRecord> implements Record9<String, String, String, String, String, Date, Date, Long, Long> {

    private static final long serialVersionUID = -112829180;
     ...
     */
    @Override
    public Row9<String, String, String, String, String, Date, Date, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row9<String, String, String, String, String, Date, Date, Long, Long> valuesRow() {
     ...
     */
    @Override
    public VehicleViewRecord values(String value1, String value2, String value3, String value4, String value5, Date value6, Date value7, Long value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public VehicleViewRecord(String licensePlate, String modelcar, String brand, String fio, String status, Date begDate, Date endDate, Long vehiclePk, Long ptsPk) {
        super(VehicleView.VEHICLE_VIEW);
