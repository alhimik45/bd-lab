...
public class AppderigistrationRecord extends UpdatableRecordImpl<AppderigistrationRecord> implements Record8<String, Long, Long, Long, Long, Long, Date, String> {

    private static final long serialVersionUID = 512789532;
    ...
    /**
     * Setter for <code>public.AppDerigistration.status</code>.
     */
    ...
    /**
     * Getter for <code>public.AppDerigistration.status</code>.
     */
    ...
    public Field<String> field8() {
        return Appderigistration.APPDERIGISTRATION.STATUS;
    }
     ...
     */
    @Override
    public AppderigistrationRecord value8(String value) {
        setStatus(value);
        return this;
    }
     ...
     */
    @Override
    public AppderigistrationRecord values(String value1, Long value2, Long value3, Long value4, Long value5, Long value6, Date value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppderigistrationRecord(String content, Long personPk, Long regcertPk, Long appderigistrationPk, Long employePk, Long personPk1, Date date, String status) {
        super(Appderigistration.APPDERIGISTRATION);
